...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = KEYMAP(
               ...
               KC_TAB         , KC_Q, KC_W, KC_E, KC_R, KC_T, LT(1,      KC_NO), /* 7 */
               KC_TRANSPARENT , KC_A, KC_S, KC_D, KC_F, KC_G, /* 6 */
               KC_LSHIFT      , KC_Z, KC_X, KC_C, KC_V, KC_B, LT(2,      KC_NO), /* 7 */


               KC_LCTL,KC_TRANSPARENT,KC_TRANSPARENT,KC_LALT,KC_LGUI, /*  */
               KC_LEFT,KC_RIGHT,
               KC_PGUP,
               KC_LGUI,KC_LSHIFT,KC_PGDOWN,
               ...
               KC_LSHIFT,   KC_TRANSPARENT,      KC_UP, KC_DOWN, TG(3),
               KC_HOME, KC_LALT,
               KC_END,
