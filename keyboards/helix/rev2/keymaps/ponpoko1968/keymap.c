...
#define M_SAMPLE M(KC_SAMPLEMACRO)
 ...
 const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_RAISE] = LAYOUT( \
                    ...
                    _______ , KC_LEFT  ,KC_DOWN      ,   KC_RIGHT  ,  KC_DLR ,  KC_PERC ,                    KC_UNDS ,   KC_PLUS , KC_LCBR  , KC_RCBR , KC_PIPE   ,   _______ , \
                    _______ , KC_END   ,  KC_1       ,   KC_2      ,  KC_HASH,  KC_GRAVE,  KC_PGUP,_______,  KC_QUOT ,   KC_DQT  ,  _______  , _______   , _______ ,    _______ , \
