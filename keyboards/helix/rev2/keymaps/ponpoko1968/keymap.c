...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [_QWERTY] = LAYOUT( \
                     KC_ESC            ,  KC_1   ,    KC_2  ,    KC_3 ,    KC_4  ,    KC_5   ,   /* dummy , dummy          , */  KC_6 ,    KC_7   ,    KC_8    ,    KC_9 ,    KC_0    , KC_BSPC , \
                     KC_TAB            ,  KC_Q   ,    KC_W  ,    KC_E ,    KC_R  ,    KC_T   ,   /* dummy , dummy          , */  KC_Y ,    KC_U   ,    KC_I    ,    KC_O ,    KC_P    , KC_DEL  , \
                     ...
                     KC_LCTL           ,  ADJUST ,  KC_LALT , KC_LALT ,  KC_LGUI ,    KC_SPC ,   LOWER    , LGUI(KC_SPACE) ,  KC_SPC  ,    LT(4,KC_SPACE) ,    KC_LEFT , KC_DOWN ,    KC_UP   , KC_RGHT \
                      ),
  ...
  [_RAISE] = LAYOUT( \
                    ...
                    _______,  _______, KC_7 ,   KC_8,    KC_9,  _______,                    KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLASH, KC_F12, \
                    _______, _______, KC_4 ,   KC_5,    KC_6,  _______,                     KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE,   _______, \
                    _______, _______, KC_1 ,   KC_2,    KC_4,  _______,  _______, _______,  KC_QUOT, KC_DQT,  _______, _______, _______,    _______, \
