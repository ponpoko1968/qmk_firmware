 ...
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  KC_LCTRL,  KC_Z,   KC_X,    KC_C,    KC_V,   KC_B, LCTL(KC_RBRACKET),  TGL_KANA, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT, \
                    ADJUST, KC_LALT,   KC_LGUI, LOWER,                                TGL_KANA, LT(_RAISE,KC_SPACE),   KC_BSPC, KC_RGUI \
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
