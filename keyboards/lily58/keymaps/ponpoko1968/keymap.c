 ...
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  KC_LCTRL,  KC_Z,   KC_X,    KC_C,    KC_V,   KC_B, LOWER,       LCTL(KC_RBRACKET), KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT, \
                         ADJUST, KC_LALT,   KC_LGUI, KC_LSFT,           TGL_KANA, LT(_RAISE,KC_SPACE),KC_RCTL, KC_RGUI \
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
...
[_LOWER] = LAYOUT( \
  ...
  KC_GRV, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                    KC_MINUS,KC_7,    KC_8,    KC_9,   KC_RPRN, _______, \
  KC_GRV, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                    KC_PLUS, KC_4,    KC_5,    KC_6,   KC_LPRN, _______, \
  _______, _______, _______, _______, _______, _______, _______, KC_EQL,  KC_SLSH, KC_1,    KC_2,    KC_3,    XXXXXXX, XXXXXXX, \
                             _______, _______, _______, _______, KC_ASTR, KC_0,    KC_DOT,_______  \
),
/* RAISE
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
