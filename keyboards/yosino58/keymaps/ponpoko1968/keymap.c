...
#define KC_SPCMCS LCTL(KC_RBRACKET)
#define C_M_T(kc)  MT(MOD_LCTL|MOD_LALT,kc)
 ...
 */
 [_QWERTY] = LAYOUT( \
                    KC_GESC,   KC_1, KC_2, KC_3, KC_4,    KC_5,                                                 KC_6,    KC_7,    KC_8,    KC_9,   KC_0,  KC_SPCMCS, \
                    KC_TAB,   KC_Q, KC_W, KC_E, KC_R,    KC_T,                                                 KC_Y,    KC_U,    KC_I,    KC_O,   KC_P,    KC_BSPC, \
                    KC_LSFT,  MT(MOD_RCTL,KC_A), KC_S, KC_D, KC_F,    KC_G,                                                 KC_H,    KC_J,    KC_K,    KC_L,   KC_SCLN, KC_ENT, \
                    KC_LCTL, KC_Z, KC_X, KC_C, KC_V,    KC_B,  KC_LALT, C_M_T(TG(_LOWER)), LGUI(KC_SPACE),KC_SPCMCS, KC_N,    KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, \
                    /*                  */ MT(MOD_LSFT,KC_LCBR),   KC_LGUI, KC_LCTL,                KC_RCTL,LT(_RAISE,KC_SPACE),KC_NO \
                     ),
 ...
 */
 [_LOWER] = LAYOUT( \
  ...
  TG(_LOWER), KC_PSLS, KC_PMNS, KC_P7, KC_P8,   KC_P9,                                        KC_PMNS, KC_P7, KC_P8, KC_P9, KC_PERC, KC_F12, \
  _______, KC_PAST, KC_PPLS, KC_P4, KC_P5,   KC_P6,                                           KC_PPLS, KC_P4, KC_P5, KC_P6, KC_RPRN, KC_LPRN, \
  _______, KC_PDOT, KC_P0,   KC_P1, KC_P2,   KC_P3,   TG(_LOWER),  _______, _______, _______, KC_PSLS, KC_P1, KC_P2, KC_P3, KC_PDOT, KC_PIPE, \
                                    _______, KC_LGUI, _______,                    XXXXXXX, KC_PEQL, KC_P0                                              \
 ...
 */
 [_RAISE] = LAYOUT( \
  ...
  KC_SPCMCS,KC_HOME,KC_UP,   KC_EXLM, KC_AT,    KC_TILDE,                                    KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLASH,KC_DEL    , \
  KC_SPCMCS, KC_LEFT, KC_DOWN, KC_RIGHT,KC_DLR,   KC_PERC,                                     KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_COLN, KC_PIPE    , \
  _______, KC_END,   KC_LT,   KC_GT,  KC_HASH,   KC_GRAVE,  TG(_LOWER), ADJUST, _______, XXXXXXX, KC_QUOT, KC_DQT, KC_LT, KC_GT, KC_QUES, XXXXXXX, \
